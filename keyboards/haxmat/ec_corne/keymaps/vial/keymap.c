...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
        _______,   KC_LCBR,   S(KC_7),   S(KC_8),   S(KC_9),   KC_RCBR,   _______,   _______,   _______,   _______,   _______,   _______,
        _______,   KC_COLN,   S(KC_4),   S(KC_5),   S(KC_6),   KC_PLUS,   _______,   KC_RSFT,   KC_LCTL,   KC_LALT,   KC_LGUI,   _______,
        _______,   KC_NUHS,   S(KC_1),   S(KC_2),   S(KC_3),   S(KC_NUBS),_______,   _______,   _______,   _______,   _______,   _______,
    ...
    [_FUN] = LAYOUT(
        _______,   KC_F12,    KC_F7,     KC_F8,     KC_F9,     KC_PSCR,   DUMP_EC_THRESHOLDS,   _______,   _______,   _______,   _______,   _______,
        _______,   KC_F11,    KC_F4,     KC_F5,     KC_F6,     KC_SLCK,   _______,   KC_RSFT,   KC_LCTL,   KC_LALT,   KC_LGUI,   _______,
        _______,   KC_F10,    KC_F1,     KC_F2,     KC_F3,     KC_PAUS,   _______,   _______,   _______,   _______,   _______,   _______,
                              _______,   KC_APP,    KC_SPC,    _______,   _______,   _______
    ),

    [_NUM] = LAYOUT(
        _______,   KC_LBRC,   KC_7,      KC_8,      KC_9,      KC_RBRC,   _______,   _______,   _______,   _______,   _______,   _______,
        _______,   KC_SCLN,   KC_4,      KC_5,      KC_6,      KC_EQL,    _______,   KC_RSFT,   KC_LCTL,   KC_LALT,   KC_LGUI,   _______,
        _______,   KC_GRV,    KC_1,      KC_2,      KC_3,      KC_NUBS,   _______,   _______,   _______,   _______,   _______,   _______,
                              _______,   KC_DOT,    KC_0,      _______,   _______,   _______
    )
};

...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_3thumb(
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_AGIN, KC_PST,  KC_COPY, KC_CUT,  KC_UNDO,
    ...
    [NUM] = LAYOUT_3thumb(
        KC_LBRC, KC_7,    KC_8,    KC_9,    KC_RBRC,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [SYM] = LAYOUT_3thumb(
        KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RCBR, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [FUN] = LAYOUT_3thumb(
        KC_F12,  KC_F7,   KC_F8,   KC_F9,   KC_PSCR, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
